...
`button.py`, `colors.py`, `display_model.py`, and `encoder.py` are **verbatim
copies** of `firmware/dev/core/` — do not edit them here. The home page loads them into a MicroPython wasm runtime
